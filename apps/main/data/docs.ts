    ...
    sections: [
      {
        ...
        rules: [
          ...
          },
          {
            ...
            enforces:
              "Requires type-only imports to use the type import syntax.",
      ...
      },
      {
        ...
        rules: [
          ...
          },
          {
            ...
            enforces:
              "Requires React hook dependency arrays to include all referenced values.",
          ...
          },
          {
            ...
            enforces:
              "Requires usage of next/image instead of raw img elements in Next.js apps.",
        ...
        rules: [
          {
            ...
            enforces:
              "Disallows explicit any and requires concrete domain types.",
          ...
          },
          {
            ...
            enforces:
              "Requires promises to be awaited, returned, or intentionally handled.",
      ...
      },
      {
        ...
        rules: [
          ...
          },
          {
            ...
            enforces:
              "Warns on console usage except console.error for operational errors.",
...
export const appLinks: AppLink[] = [
  {
    id: "employer",
    label: "Employer",
    href: clientEnv.NEXT_PUBLIC_EMPLOYER_URL,
  },
  {
    id: "provider",
    label: "Provider",
    href: clientEnv.NEXT_PUBLIC_PROVIDER_URL,
  },
  {
    id: "apprentice",
    label: "Apprentice",
    href: clientEnv.NEXT_PUBLIC_APPRENTICE_URL,
  },

...
export function LoginForm() {
  ...
  return (
    <AuthCard>
      <AuthHeader
        title="Sign in"
        subtitle="Access your Gradlly administration workspace."
        icon={mainAuthContent.accentIcon}
      />
      {formError ? (
        <AuthStatusBanner
          type="error"
      ...
      <AuthFooter>
        <p>{mainAuthContent.supportText}</p>
      </AuthFooter>
      <AuthLegalText>{mainAuthContent.legalText}</AuthLegalText>
    </AuthCard>
  );
}

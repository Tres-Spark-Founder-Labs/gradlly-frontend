...
export default function AuthLayout({ children }) {
  return (
    <div className="min-h-screen grid grid-cols-1 lg:grid-cols-2 bg-[#f7f7f2] font-sans antialiased">
      <aside className="hidden lg:flex relative overflow-hidden bg-primary-900 flex-col">
        <AuthLayoutSVG />
        <div className="relative z-10 mt-auto w-full px-12 xl:px-16 pb-14 xl:pb-16">
          <span className="inline-block text-[11px] font-semibold uppercase tracking-[0.22em] text-primary-300 mb-4">
            Employer Platform
          </span>
          <h2
            className="text-[30px] xl:text-[38px] font-bold text-primary-50 leading-[1.1] tracking-tight mb-4"
            style={{
              textShadow:
                "0 2px 24px color-mix(in srgb, var(--color-primary-950) 55%, transparent)",
            }}
          >
            Hire, onboard and manage apprentices in one place.
          </h2>
          <p className="text-[14px] xl:text-[15px] font-light leading-relaxed text-primary-200">

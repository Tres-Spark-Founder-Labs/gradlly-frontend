...
export function LoginForm() {
  ...
  const onSubmit = async () => {
    ...
    setFormError(
      "We could not sign you in at the moment. Please review your details and try again.",
    );
  };
  ...
  return (
    <AuthCard>
      <AuthHeader
        title="Sign in"
        subtitle="Access automation insights and orchestration tools."
        icon={flowAuthContent.accentIcon}
      />
      {formError ? (
        <AuthStatusBanner
          type="error"
      ...
      <AuthFooter>
        <p>{flowAuthContent.supportText}</p>
      </AuthFooter>
      <AuthLegalText>{flowAuthContent.legalText}</AuthLegalText>
    </AuthCard>
  );
}
